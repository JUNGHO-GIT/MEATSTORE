		...
		<section>
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 d-flex justify-content-center align-items-center">
					<form name="insertForm" class="m-4" method="post" action="${ctxpath}/notice/insertPro.do" onSubmit="return check()">
						<input type="hidden" name="num" value="${num}" />
						<div class="form-group">
							<input class="form-control" type="text" name="title" id="title" size="50" placeholder="글 제목을 입력하세요." />
						</div>
						<div class="form-group">
