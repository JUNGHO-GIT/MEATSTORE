...
<html lang="ko, en">
  ...
  <head>
	...
	<body>
		...
		<!-- form ------------------------------------------------------------------------------------->
		<form name="writeForm" method="post" enctype="multipart/form-data" action="${ctxpath}/board/writePro.do" onsubmit="return check()">
						...
						<div class="component-jungho1">
							<div class="col-sm-12">
								<h6>
									...
									<input type="reset" onclick="window.location.reload()" class="btn btn-jungho" value="목록보기" /> &nbsp;
						...
						<div class="social-buttons" data-aos="fade-up" data-aos-duration="700">
							<div class="row">
								...
								<div class="col-sm-7 col-md-6">
									<ul class="mbm_social">
										<li>
											<a class="social-facebook" href="www.facebook.com">
										...
										<li>
											<a class="social-twitter" href="www.twitter.com">
										...
										<li>
											<a class="social-google-plus" href="www.pinterest.com">
