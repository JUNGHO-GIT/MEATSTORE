...
<% request.setCharacterEncoding("UTF-8"); %>
  ...
  <c:if test="${count > 0}">
    ...
    <section class="section">
      <form action="${ctxPath}/cart/deletePro.do" method="post" name="cartForm">
            ...
            <table id="productTable" class="table table-striped dataTable table-hover" style="border: 1px solid #dddddd;">
              ...
              <tfoot>
                <tr>
                  ...
                  <th colspan="2" id="totalPrice" class="jungho-center ft-8 fw-5">
                    <fmt:formatNumber value="${totalPrice}" type="currency" currencySymbol="₩"/>
                  </th>
                  <th colspan="2" class="jungho-center ft-8 fw-5">
                    <button type="button" id="orderButton" class="btn btn-jungho" onclick="window.location.href='${ctxPath}/order/listPro.do'">주문하기</button>
                  </th>
                </tr>
              </tfoot>
            </table>
