  ...
  <link rel="stylesheet" href="${ctxpath}/css/inputForm_css.css" />
  		...
  		<form name="inputForm" method="post" action="${ctxpath}/member/inputPro.do"
  			...
  			<table class="dataTable">
  				<tr>
  					<td>ID</td>
  					<td>
  						<input class="text_box_2" type="text" name="id" id="id" size="20"
  							placeholder="id입력" />
  				...
  				<tr>
  					<td>이름</td>
  					<td>
  						<input class="text_box" type="text" name="name" id="name" size="30"
  							placeholder="입력" />
  					</td>
  				</tr>
  				<tr>
  					<td>이메일</td>
  					<td>
  						<input class="text_box" type="text" name="email" id="email" size="30"
  				...
  				<tr>
  					<td>전화</td>
  					<td>
  						<input class="text_box" type="text" name="tel" id="tel" size="14"
  							placeholder="전화번호입력" />
  					</td>
  				</tr>
  				<tr>
  				...
  				<tr>
  					<td colspan="2" align="center" class="submit_id">
  						...
  						<br />
  						<input class="button_noInput" type="button" value="가입안함"
  							onClick="location='${ctxpath}/template/template.jsp'" />
  					</td>
  				</tr>
  			</table>
  		</form>
