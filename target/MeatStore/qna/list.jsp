			...
			<div class="jumbotron d-flex align-items-center">
				...
				<div class="container-fluid content">
					...
					<h2 data-aos="fade-left" data-aos-delay="300">[전체글 : ${count}]</h1>
						<h2>
							<button class="btn btn-jungho" data-aos="fade-up" data-aos-delay="300" onclick="window.location.href='${ctxpath}/qna/writeForm.do'">글쓰기</button>
						</h2>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 d-flex justify-content-center align-items-center">
						<div class="search_page d-flex justify-content-center align-items-center">
							<form method="GET" name="search_list" action="${ctxpath}/qna/searchList.do" class="form-inline">
